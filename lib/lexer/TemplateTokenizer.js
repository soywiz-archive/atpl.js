StringReader        = require('./StringReader.js').StringReader;
ExpressionTokenizer = require('./ExpressionTokenizer.js').ExpressionTokenizer;

var TemplateTokenizer = function(string) {
	this.string       = string;
};
