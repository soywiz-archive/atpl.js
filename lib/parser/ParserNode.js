...
var ParserNodeReturnExtends = (function (_super) {
    __extends(ParserNodeReturnExtends, _super);
    function ParserNodeReturnExtends(expression) {
        _super.call(this);
        this.expression = expression;
    }
    ParserNodeReturnExtends.prototype.generateCode = function () {
        return 'return runtimeContext.extends(' + this.expression.generateCode() + ');';
    };
    return ParserNodeReturnExtends;
})(ParserNode);
exports.ParserNodeReturnExtends = ParserNodeReturnExtends;
