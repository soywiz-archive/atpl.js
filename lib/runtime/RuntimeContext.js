...
var RuntimeContext = (function () {
    ...
    RuntimeContext.prototype.use = function (currentTemplate, name, pairs) {
    ...
    RuntimeContext.prototype._putBlock = function (Current, name, avoidRender) {
    ...
    RuntimeContext.prototype.putBlock = function (name, avoidRender) {
