...
describe('TemplateTokenizer', function () {
    it('just plain text', function () {
        //console.log(assert);
        var templateTokenizer = new TemplateTokenizer_1.TemplateTokenizer('plain text');
    ...
    it('comments test', function () {
        var templateTokenizer = new TemplateTokenizer_1.TemplateTokenizer('plain text {# this is a comment #} Hello! {# this is another comment #} ');
        var tokens = templateTokenizer.tokenizeAll();
        assert.equal(JSON.stringify([
